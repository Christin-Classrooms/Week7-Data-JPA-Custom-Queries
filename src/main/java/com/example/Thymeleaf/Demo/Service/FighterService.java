...
public class FighterService {
    ...
    public Page<Fighter> findFightersByName(String name, Pageable pageable) {
        return fighterRepository.findByNameContainingIgnoreCase(name, pageable);
    }

    public Page<Fighter> findFightersByHealth(int health, Pageable pageable) {
    ...
    public Page<Fighter> findBalancedFighters(int minHealth, double maxDamage, Pageable pageable) {
